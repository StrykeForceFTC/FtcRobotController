...
public class low_level_class extends OpMode

{
    ...
    double drive_calc (double inches)
    {
        double goal = inches/(1.5*3.141592)*1440;
        return goal;
    }
    double turn_calc (double degrees)
    {
        double clicks = ((16*3.141592)/360*degrees)/(1.5*3.141592)*1440;
        return clicks;
    }
