 ...
 */
public class redauto extends low_level_class
{
  ...
  @Override public void loop ()
  {
    ...
    switch (v_state)
    { //Red, going to floor parking spot
            /*case 0:
                ...
                if (DriveLeft.getCurrentPosition()-initEncoder>drive_calc(10))
                {
            ...
            case 1:
                DriveLeft.setPower(-0.25);
                DriveRight.setPower(0.25);
                if (DriveLeft.getCurrentPosition()-initEncoder<-250)
                {
                    DriveLeft.setPower(0);
                    DriveRight.setPower(0);
            ...
            case 2:
                ...
                if (DriveLeft.getCurrentPosition()-initEncoder>drive_calc(60))
                {
                    DriveLeft.setPower(0);
                    DriveRight.setPower(0);
                    v_state++;
            ...
            case 3:
                ...
                if (DriveLeft.getCurrentPosition()-initEncoder<-drive_calc(2))
                {
                    DriveLeft.setPower(0);
                    DriveRight.setPower(0);
                    v_state++;
            ...
            case 4:
                ...
                if (DriveLeft.getCurrentPosition()-initEncoder>drive_calc(3))
                {
                    DriveLeft.setPower(0);
                    DriveRight.setPower(0);
                    v_state++;
